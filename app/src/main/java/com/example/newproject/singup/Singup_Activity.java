...
public class Singup_Activity extends AppCompatActivity {
    ImageButton ib_back;
    Button btn_next, btn_signup_email_confire,  btn_email_certification_check;
    EditText et_email_signup, et_email_certification;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(), Singup_Activity2.class);
                ...
                if (!email.isEmpty()) {
                    ...
                    try {
                        ...
                        if(success){
                            ...
                            Toast.makeText(Singup_Activity.this, "중복된 이메일 입니다.", Toast.LENGTH_SHORT).show();
                        }
    ...
    private void checkEmailValidity() {
        ...
        if (isValidEmail(email)) {
            ...
            btn_signup_email_confire.setEnabled(true);
        } else {
            tv_check_email.setVisibility(View.VISIBLE);
