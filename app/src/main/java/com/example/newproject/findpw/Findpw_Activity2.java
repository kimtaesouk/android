...
public class Findpw_Activity2 extends AppCompatActivity {
    Button btn_next;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_findpw2);
        ...
        btn_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                setData(email,et_pw_findpw.getText().toString() );
    ...
    private void setData(String email, String pw) {
        ...
        // get방식 파라미터 추가
        HttpUrl.Builder urlBuilder = HttpUrl.parse("http://49.247.32.169/NewProject/Change_pw.php").newBuilder();
